...
<style>
  ...
  .main {
    ...
    background-image: url(https://mega.com.vn/media/news/2006_hinh-nen-sky-galaxy-laptop5.jpg);
  }
  .form {
    width: 360px;
    min-height: 100px;
	...
	<div class="main">
        ...
        <form action="thanhtoan" method="post" class="form" id="form-1">
          ...
          <div class="form-group">
            ...
            <input id="fullname" name="fullname" type="text" placeholder="VD:Hanhdeptrao" class="form-control" value=<%=kh != null ? kh.getTenkh(): "" %>>
          ...
          <div class="form-group">
            ...
            <input id="address" name="address" type="text" placeholder="74 Ngu Binh, Huế" class="form-control" value=<%=kh != null ? kh.getDiachi() : "" %>>
            <span class="form-message"></span>
          </div>
          ...
          <span class="total">Tổng Tiền: <strong><%=gh.TongTien() %></strong> VND</span>
